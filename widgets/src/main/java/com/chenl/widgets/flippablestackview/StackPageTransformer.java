...
package com.chenl.widgets.flippablestackview;
    ...
    public void transformPage(View view, float position) {
        ...
        switch (mOrientation) {
            case VERTICAL:
                ...
                ViewHelper.setPivotY(view,dimen / 2f);
                ViewHelper.setPivotX(view,view.getWidth() / 2f);
                break;
            case HORIZONTAL:
                ViewHelper.setRotationY(view,0);
                ViewHelper.setPivotX(view,dimen / 2f);
        ...
        if (position < - mNumberOfStacked - 1) {
            ...
            ViewHelper.setAlpha(view,1.0f + (position * mAlphaFactor));
            switch (mOrientation) {
                case VERTICAL:
                    ViewHelper.setTranslationY(view,baseTranslation + shiftTranslation);
                    break;
                case HORIZONTAL:
                    ViewHelper.setTranslationX(view,baseTranslation + shiftTranslation);
                    break;
            }
        } else if (position <= 1) {
            float baseTranslation = position * dimen;
            ...
            switch (mOrientation) {
                case VERTICAL:
                    ViewHelper.setPivotY(view,dimen);
                    ViewHelper.setRotationX(view,rotation);
                    ViewHelper.setScaleX(view,mZeroPositionScale);
                    ViewHelper.setScaleY(view,scale);
                    ViewHelper.setTranslationY(view,-baseTranslation - mBelowStackSpace - shiftTranslation);
                    break;
                case HORIZONTAL:
                    ViewHelper.setPivotX(view,dimen);
                    ViewHelper.setRotationY(view,-rotation);
                    ViewHelper.setScaleY(view,mZeroPositionScale);
                    ViewHelper.setScaleX(view,scale);
                    ViewHelper.setTranslationX(view,-baseTranslation - mBelowStackSpace - shiftTranslation);
                    break;
            }
        } else if (position > 1) {
            ViewHelper.setAlpha(view,0f);
