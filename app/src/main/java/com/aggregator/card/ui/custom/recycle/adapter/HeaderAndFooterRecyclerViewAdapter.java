        ...
        if (manager instanceof GridLayoutManager) {
            ...
            gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    int spanSize = (isHeader(position) || isFooter(position))
                            ? gridManager.getSpanCount() : (spanSizeLookup != null ? spanSizeLookup.getSpanSize(position - getHeaderViewsCount()) : 1);
                    return spanSize;
                }
            });
        }
...
//                && (RecyclerViewUtils.getLayoutPosition() == TYPE_HEADER || getItemViewType(holder.getLayoutPosition()) == TYPE_FOOTER)) {
...
//    }
    ...
    public int getItemViewType(int position) {
        ...
        if (position < headerViewsCountCount) {
            ...
            int innerPosition = position - headerViewsCountCount;
            int innerItemViewType = mInnerAdapter.getItemViewType(innerPosition);
